 ...
 * @author Phavour
 */
public class UpdateCourseTeach extends javax.swing.JFrame {

	/**
	 * Creates new form UpdateTeacher
	 */
	public UpdateCourseTeach() {
		initComponents();
	}
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        if (!fstNameText3.getText().equals("") && !lstNameText3.getText().equals("")
				&& !courseCodeText3.getText().equals("")) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(UpdateCourseTeach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new UpdateCourseTeach().setVisible(true);
			}
		});
	}
