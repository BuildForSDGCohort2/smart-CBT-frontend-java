 ...
 * @author Phavour
 */
public class StudentsPaneTeach extends javax.swing.JFrame {

	/**
	 * Creates new form TeachersPane
	 */
	public StudentsPaneTeach() {
		initComponents();
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        DeleteStudentTeach delST = new DeleteStudentTeach();
...
//        }
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(StudentsPaneTeach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new StudentsPaneTeach().setVisible(true);
			}
		});
	}
